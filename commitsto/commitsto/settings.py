"""
Django settings for commitsto project.
...
SECRET_KEY = 'django-insecure-!$d^f^2)s)(vp87^jh#dz-^k7d$7qo=tnrfj7z27x7a=cy*-s+'
...
WSGI_APPLICATION = 'commitsto.wsgi.application'
